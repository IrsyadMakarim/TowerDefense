...
namespace Assets.Scripts.Module.Gameplay.Tower.Model
{
    public class TowerModel : MonoBehaviour
    {
        ...
        /// <summary>
        /// mengembalikan sprite icon untuk tower
        /// </summary>
        ...
        public void CheckNearestEnemy(List<EnemyModel> enemies)
        {
        ...
        public void ShootTarget()
        {
            ...
            if (_runningShootDelay <= 0f)
            {
                ...
                BulletModel bullet = LevelManager.Instance.GetBulletFromPool(_bulletPrefab);
