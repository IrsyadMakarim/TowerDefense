...
namespace Assets.Scripts.Module.Gameplay.Tower.View
{
    public class TowerView : MonoBehaviour, IBeginDragHandler, IDragHandler,
        IEndDragHandler
    {
        [SerializeField] private Image _towerIcon;

        private TowerModel _towerPrefab;
        private TowerModel _currentSpawnedTower;

        public void SetTowerPrefab(TowerModel tower)
        {
            _towerPrefab = tower;
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            _currentSpawnedTower = newTowerObj.GetComponent<TowerModel>();
